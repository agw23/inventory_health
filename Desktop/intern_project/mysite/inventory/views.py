...
class HomeView(TemplateView):
    ...
    def post(self, request):
        ...
        try:
                ...
                hello = dev.rpc.show_interface_diagnostics_information()

                print (etree.tostring(hello, encoding='unicode'))
    ...
    def post(self, request):
        ...
        if request.method == "POST":
                ...
                args = {'ip_checked': ips_checked, 'serial': serial, 'model': model, 'uptime': uptime,
                   'packets_received':packets_received, 'packets_sent': packets_sent, 'cpu_idle': cpu_idle,
...
class HorizontalChartSystemAlarms(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        trace1 = go.Bar(x=self.list_alarm_count_,
                        ...
                        text=['For more information, click on "more details"'],
                        marker=dict(
...
class ByDescription(TemplateView):
    def __init__(self):
    ...
    def get(self, request):
        ...
        args = {'data': self.data, 'values': self.my_dict.values()}

        return render(request, 'polls/alarm_count.html', args)
    ...
    def get_description(self):
        ...
        print ("before return")
        print (self.alarm_description_list)
        return self.my_dict.items()
...
def filter(request):
    ...
    return render(request, 'polls/filter_table_health_options.html')
